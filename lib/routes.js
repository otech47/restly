...
var parseRequest = function(apicall, req, res) {
  ...
  if(errors.length) {
    ...
    return res.status(404).send({ "status": "failure", "version": req.params.vid, "error": errors, payload: {}});
  ...
  if(apicall.callback && apicall.library) {
    ...
    if (apicall.authentication) {
      series.auth = function(callback) {
        ...
        auth_lib[apicall.authentication.callback](req, res, opts, function(err, data) {
